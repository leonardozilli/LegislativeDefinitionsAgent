...
def filter_definitions(
    ...
    if relevant_ids:
        filtered_docs = [doc for doc in filtered_docs if doc.metadata["id"] in relevant_ids]

    if legislation:
        filtered_docs = [
            doc for doc in filtered_docs if settings.COLLECTIONS[doc.metadata["dataset"]].get("legid") == legislation
        ]
